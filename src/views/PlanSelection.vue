    ...
    <section ref="plansRef" class="py-20 bg-gray-50 text-center">
      ...
      <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto px-4">
        ...
        <div class="bg-white rounded-2xl shadow-md p-8 flex flex-col">
          ...
          <button @click="selectPlan('free')" class="w-full bg-gray-100 hover:bg-gray-200 py-3 rounded-xl font-semibold">
        ...
        <div class="bg-white rounded-2xl shadow-xl border-2 border-blue-500 p-8 flex flex-col relative transform scale-105">
          ...
          <button @click="selectPlan('pro')" class="w-full bg-blue-500 hover:bg-blue-600 text-white py-3 rounded-xl font-semibold">
            Choisir Pro
          </button>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-md p-8 flex flex-col">
          ...
          <button @click="selectPlan('premium')" class="w-full bg-purple-500 hover:bg-purple-600 text-white py-3 rounded-xl font-semibold">
            Choisir Premium
          </button>
        </div>
