...
onMounted(() => {
  ...
  // Cette tentative est confirmée : on invalide le jeton immédiatement pour
  // qu'une page restaurée plus tard (bfcache, retour arrière) sur cette même
  // URL ne puisse plus jamais réafficher "succès".
  localStorage.removeItem("stripePendingAttempt")
