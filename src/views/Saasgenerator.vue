...
const publishSite = async () => {
  ...
  const urlUid  = `https://mronlinestores.com/${uid}`
...
.prev-feat-icon{font-size:28px;display:block;margin-bottom:8px}.prev-feature-card strong{font-size:14px;color:#111;display:block;margin-bottom:4px}
